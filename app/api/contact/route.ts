...
export async function POST(req: NextRequest) {
  try {
    ...
    await resend.emails.send({
      from: "WeeTramz Website <onboarding@resend.dev>",
        ...
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <div style="background: #f8fafc; padding: 24px; border-radius: 0 0 8px 8px; border: 1px solid #e2e8f0;">
            <table style="width: 100%; border-collapse: collapse;">
              ...
              <tr><td style="padding: 8px 0; font-size: 13px; color: #64748b;">Email</td><td style="padding: 8px 0; font-size: 14px; color: #0066CC;"><a href="mailto:${email}" style="color: #0066CC;">${email}</a></td></tr>
