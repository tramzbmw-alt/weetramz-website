        ...
        <div className="max-w-3xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <dl className="space-y-4">
              <div>
                ...
                <dd className="mt-1">
                  <a href={PHONE_HREF} className="text-gray-900 font-semibold hover:text-[#0066CC]">{PHONE}</a>
                </dd>
              </div>
              <div>
                <dt className="text-xs font-semibold text-gray-400 uppercase tracking-wider">Email</dt>
                <dd className="mt-1">
                  <a href={EMAIL_HREF} className="text-gray-900 font-semibold hover:text-[#0066CC]">{EMAIL}</a>
                </dd>
              </div>
              <div>
            ...
            <div className="mt-8 p-4 bg-blue-50 border border-blue-200 rounded-lg">
              ...
              <a href={QUOTE_URL} target="_blank" rel="noopener noreferrer"
                className="mt-3 inline-block px-4 py-2 bg-[#0066CC] hover:bg-[#0052a3] text-gray-900 font-semibold text-sm rounded-lg transition-colors">
                Request a Quote
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mb-4">
              ...
              <a href={QUOTE_URL} target="_blank" rel="noopener noreferrer" className="text-[#0066CC] hover:underline font-medium">
                Quote Agent
              </a>
