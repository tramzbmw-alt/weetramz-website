    ...
    <>
      ...
      <section className="py-16 px-6 bg-white">
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
          {services.map((s) => (
            <div key={s.title} className="group rounded-xl border border-gray-100 shadow-sm p-6 hover:bg-[#0A1628] hover:border-[#2657f2] hover:-translate-y-2 transition-all duration-200 cursor-default border-[#2657f2]/20">
              <h2 className="font-black text-gray-900 text-lg group-hover:text-[#2657f2] transition-colors">{s.title}</h2>
