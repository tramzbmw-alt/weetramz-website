    ...
    <>
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#2657f2]/10 text-[#2657f2] text-xs font-bold mb-6">
              🏆 Industry First
            </div>
            <h2
            ...
            >
              ...
              <em style={{ fontStyle: "italic", color: "#2657f2" }}>AI for parents.</em>
            </h2>
            ...
            <ul className="space-y-3 mb-8">
              {[
                ...
                <li key={q} className="flex items-center gap-3 text-sm text-gray-700">
                  <span className="text-[#2657f2] font-bold">→</span>
          ...
          <div className="bg-[#0d1b2a] rounded-2xl p-6 shadow-2xl">
            <div className="flex items-center gap-2 mb-6 pb-4 border-b border-white/10">
              <div className="w-8 h-8 rounded-full bg-[#2657f2] flex items-center justify-center text-white font-bold text-sm">W</div>
              <div>
            ...
            <div className="space-y-4">
              <div className="flex justify-end">
                <div className="bg-[#2657f2] text-white text-sm rounded-2xl rounded-tr-sm px-4 py-2.5 max-w-xs">
                  Where is the bus right now?
                </div>
              </div>
              <div className="flex gap-2">
                <div className="w-6 h-6 rounded-full bg-[#2657f2]/20 flex items-center justify-center text-xs flex-shrink-0 mt-1">W</div>
            ...
            <div className="mt-6 pt-4 border-t border-white/10 flex gap-2">
              ...
              <button className="w-8 h-8 bg-[#2657f2] rounded-lg flex items-center justify-center text-white">→</button>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 bg-[#0A1628]">
        <div className="max-w-6xl mx-auto">
          <div className="mb-12">
            <p className="text-xs font-bold text-[#2657f2] uppercase tracking-widest mb-2">APP FEATURES</p>
            <h2
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-4xl mx-auto">
          <div className="mb-12 text-center">
            <p className="text-xs font-bold text-[#2657f2] uppercase tracking-widest mb-2">Getting Started</p>
            <h2
